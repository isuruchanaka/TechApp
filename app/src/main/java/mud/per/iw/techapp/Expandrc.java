...
public class Expandrc extends RecyclerView.Adapter<Expandrc.ViewHolder>{
    public static List<rcdatas> rcprds;
    ...
    public Expandrc(List<rcdatas> prds) {
        this.rcprds = prds;
    ...
    @Override
    public Expandrc.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        this.context = viewGroup.getContext();
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.expandrc, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final Expandrc.ViewHolder viewHolder, final  int i) {

        //viewHolder.setIsRecyclable(false);


        Log.wtf("biu",rcprds.get(i).getpuid());
        viewHolder.visitd.setText(rcprds.get(i).getpdesc());
        viewHolder.visitbr.setText("Corrective Action: " +rcprds.get(i).getpdesc());
        ...
        viewHolder.rmvly.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                rcprds.remove(i);
                notifyItemRemoved(i);
                notifyItemRangeChanged(i, rcprds.size());
