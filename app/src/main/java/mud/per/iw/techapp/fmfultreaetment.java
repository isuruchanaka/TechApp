...
public class fmfultreaetment extends Fragment implements AdapterView.OnItemSelectedListener, AdapterView.OnItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fr_fmfultreaetment, container, false);
...
////////////////////////////////////////////////////////////////////////////////
        ...
        String[] stockArr2 = new String[frgmenthome.sptypList.size()+1];
        stockArr2 = frgmenthome.sptypList.toArray(stockArr2);

        ArrayAdapter<String> adapter2 = new ArrayAdapter<String>(container.getContext(),R.layout.spinner_item, stockArr2);

        spinner2.setAdapter(adapter2);
        stockArr2[frgmenthome.sptypList.size()]="-Select Species Type-";
        spinner2.setSelection(frgmenthome.sptypList.size());
...
//                        break;
                    case R.id.radioButton2:
                        ...
                        String spcpos3 = frgmenthome.sptypList1.get(spcpos1);
                        view.findViewById(R.id.loadingPanel).setVisibility(View.VISIBLE);
                        getprodc(spcpos3);
                        prtype="Chemical";
                        break;
                    case R.id.radioButton3:
                        ...
                        view.findViewById(R.id.loadingPanel).setVisibility(View.VISIBLE);
                        String spcpos4 = frgmenthome.sptypList1.get(spcpos5);
                        getprodp(spcpos4);
                        prtype="Product";
                        break;
                }
...
/////////////////////////////////////////////////////////////////////////////////////////
        ...
        mMapView.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(GoogleMap mMap) {
                googleMap = mMap;
                mMap.setOnMarkerClickListener(fmfultreaetment.this::onMarkerClick);
        ...
        spbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    int spcpos = spinner2.getSelectedItemPosition();
                    String spcpos2 = frgmenthome.sptypList1.get(spcpos);
                    if (spcpos2 != null) {
...
//                        srmk1 = srmk.getText().toString();
                        ...
                        //if(validate2()) {
                        Species a = new Species("0", sbread1, sage1, spinner2.getSelectedItem().toString(), savg1, sdead1, scnt1, spcpos2);
                        spdata.add(a);
...
//                String subpos2 = SecondFragment.sitetypList1.get(subpos);
                ...
                if(validate()){
                    ...
                    try{
                        isertdata(al.getUId(),"1002",visitdesc1,svcid,ctry,spcpos2);
                    }catch (Exception ex){}
                    Log.wtf("cls1", qrcod);
                }
                else{
...
//        }
                        ...
                        try {
                            ...
                            if(sps!=null) {
                                for (int u = 0; u < sps.size(); u++) {
                                    try{
                                        isertsp(s1, sps.get(u).getspuid(), sps.get(u).getspdesc(), sps.get(u).getavgcns(), sps.get(u).getdeadpr(), sps.get(u).getage(), sps.get(u).getbreed(), sps.get(u).getcnt(), svcid,ctry, sps.get(u).getrmk());
                                    }catch (Exception ex){}
    ...
    public String isertpr(String visitid ,String prid,String empid,String spuid,String unit,String unitid,String cntry){
        String url = getContext().getResources().getString( R.string.weburl17)+"?visitid="+visitid+"&prid="+prid+"&empid="+empid+"&spuid=0&Qty="+unit+"&UnitUId="+unitid+"&cntry="+cntry+"&sptp="+spuid+"";
