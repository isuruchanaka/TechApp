...
public class fmcallback extends Fragment implements AdapterView.OnItemSelectedListener, AdapterView.OnItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fr_fmcallback, container, false);
...
/////////////////////////////////////////////////////////////////////////////////////////
        ...
        mMapView.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(GoogleMap mMap) {
                googleMap = mMap;
                mMap.setOnMarkerClickListener(fmcallback.this::onMarkerClick);
...
//                String subpos2 = SecondFragment.sitetypList1.get(subpos);
                ...
                if(validate()){
                    ...
                    try{
                        isertdata(al.getUId(),"1003",visitdesc1,svcid,ctry,spcpos2);
                    }catch (Exception ex){}
                    Log.wtf("cls1", qrcod);
                }
                else{
    ...
    public boolean validate() {
        ...
        try {
            ...
            if(data3.size()<1) {
                ...
                Toast.makeText(getContext(), "No Internt!",
                        Toast.LENGTH_LONG).show();
                valid = false;
            }
...
// Access the RequestQueue through your singleton class.
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == TAKE_PHOTO_CODE && resultCode == RESULT_OK) {
            ...
            adapter = new GridViewImageAdapter2(fmcallback.this.getContext(), fmtargettrmnt.imagePaths,
                    columnWidth);
