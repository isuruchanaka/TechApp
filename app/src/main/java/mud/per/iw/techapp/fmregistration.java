...
public class fmregistration extends Fragment implements AdapterView.OnItemSelectedListener, AdapterView.OnItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_fmregistration, container, false);
                ...
                if(validate()){
                    ...
                    if(!ll.getText().equals("Enable GPS!")) {
                        ...
                        try {
                            ...
                            isertdata(qrcod, subpos2, stpos2, sdesc1, lti, lngi, ctry, svcid, "2005", visitdesc1, svcid);
                            Log.wtf("cls1", qrcod);
