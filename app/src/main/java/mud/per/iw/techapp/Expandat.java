...
public class Expandat extends RecyclerView.Adapter<Expandat.ViewHolder>{
    public static List<atdatas> atprds;
    ...
    public Expandat(List<atdatas> prds) {
        this.atprds = prds;
    ...
    @Override
    public Expandat.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        this.context = viewGroup.getContext();
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.expandat, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final Expandat.ViewHolder viewHolder, final  int i) {

        //viewHolder.setIsRecyclable(false);


        Log.wtf("biu",atprds.get(i).getpuid());
        viewHolder.visitd.setText(atprds.get(i).getpdesc());
        viewHolder.visitbr.setText("Corrective Action: " +atprds.get(i).getpdesc());
        ...
        viewHolder.rmvly.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                atprds.remove(i);
                notifyItemRemoved(i);
                notifyItemRangeChanged(i, atprds.size());
