...
public class fminspection extends Fragment implements AdapterView.OnItemSelectedListener, AdapterView.OnItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fr_fminspection, container, false);
...
/////////////////////////////////////////////////////////////////////////////////////////
        ...
        mMapView.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(GoogleMap mMap) {
                googleMap = mMap;
                mMap.setOnMarkerClickListener(fminspection.this::onMarkerClick);
...
//                String subpos2 = SecondFragment.sitetypList1.get(subpos);
                ...
                if(validate()){
                    ...
                    try{
                        isertdata(al.getUId(),"1004",visitdesc1,svcid,ctry,spcpos2);
                    }catch (Exception ex){}
                    Log.wtf("cls1", qrcod);
                }
                else{
